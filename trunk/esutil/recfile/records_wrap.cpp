...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Records_Write", (PyCFunction) _wrap_Records_Write, METH_VARARGS | METH_KEYWORDS, (char *)"\n"
		...
		"		read back in these will not compare equal!  This is useful\n"
		"		when writing files to be read in by programs that do not\n"
		"		recognize null characters, e.g. sqlite databases.\n"
		"	ignorenull=False:\n"
