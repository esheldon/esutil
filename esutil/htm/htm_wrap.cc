...
/*-----------------------------------------------
              @(target):= _htm.so
  ------------------------------------------------*/
#define SWIG_init    init_htm

#define SWIG_name    "_htm"
...
SWIGINTERN PyObject *_wrap_new_HTM__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:new_HTM",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_HTM" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  try {
    result = (HTM *)new HTM(arg1);
  }
  catch(char const *_e) {
...
SWIGINTERN PyObject *_wrap_delete_HTM(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  HTM *arg1 = (HTM *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_HTM",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_HTM, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_HTM" "', argument " "1"" of type '" "HTM *""'"); 
  }
  arg1 = reinterpret_cast< HTM * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_HTM_lookup_id(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  HTM *arg1 = (HTM *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:HTM_lookup_id",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_HTM, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "HTM_lookup_id" "', argument " "1"" of type '" "HTM *""'"); 
  }
  arg1 = reinterpret_cast< HTM * >(argp1);
  arg2 = obj1;
  arg3 = obj2;
...
SWIGINTERN PyObject *HTM_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  SWIG_TypeNewClientData(SWIGTYPE_p_HTM, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
