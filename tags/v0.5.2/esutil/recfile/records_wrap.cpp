...
SWIGINTERN PyObject *_wrap_new_Records(PyObject *SWIGUNUSEDPARM(self), PyObject *args, PyObject *kwargs) {
  ...
  PyObject * obj5 = 0 ;
  char *  kwnames[] = {
    (char *) "fileobj",(char *) "mode",(char *) "delim",(char *) "dtype",(char *) "nrows",(char *) "bracket_arrays", NULL 
  };
  Records *result = 0 ;
  
  if (!PyArg_ParseTupleAndKeywords(args,kwargs,(char *)"OO|OOOO:new_Records",kwnames,&obj0,&obj1,&obj2,&obj3,&obj4,&obj5)) SWIG_fail;
  arg1 = obj0;
  ...
  if (obj5) {
    ...
    if (!SWIG_IsOK(ecode6)) {
      SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "new_Records" "', argument " "6"" of type '" "int""'");
    } 
    arg6 = static_cast< int >(val6);
  }
  try {
    result = (Records *)new Records(arg1,(char const *)arg2,arg3,arg4,arg5,arg6);
  }
  catch(char const *_e) {
